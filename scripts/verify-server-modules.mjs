...
writeFileSync(tsconfigPath, `${JSON.stringify({
  ...
  include: [
    ...
    join(repoRoot, 'src', 'server', 'appServerNotificationListeners.ts'),
    join(repoRoot, 'src', 'server', 'appServerNotificationState.ts'),
    join(repoRoot, 'src', 'server', 'appServerNotificationRuntimeSync.ts'),
    ...
    join(repoRoot, 'src', 'server', 'appServerRpcResponse.ts'),
    ...
    join(repoRoot, 'src', 'server', 'appServerRuntimeInterrupt.ts'),
    join(repoRoot, 'src', 'server', 'appServerRuntimeStart.ts'),
    ...
    join(repoRoot, 'src', 'server', 'appServerPendingRpcStore.ts'),
    join(repoRoot, 'src', 'server', 'appServerSessionCleanup.ts'),
    join(repoRoot, 'src', 'server', 'appServerProcessTermination.ts'),
    ...
    join(repoRoot, 'src', 'server', 'rpcProxyRoute.ts'),
    join(repoRoot, 'src', 'server', 'runtimeActionRoutes.ts'),
    join(repoRoot, 'src', 'server', 'runtimeStateRoutes.ts'),
    join(repoRoot, 'src', 'server', 'runtimeState.ts'),
    join(repoRoot, 'src', 'server', 'serverRequestRoutes.ts'),
    join(repoRoot, 'src', 'server', 'serverRequestDiagnostics.ts'),
    join(repoRoot, 'src', 'server', 'serverRequestPolicy.ts'),
    join(repoRoot, 'src', 'server', 'statusRoutes.ts'),
    join(repoRoot, 'src', 'server', 'threadRoutes.ts'),
    ...
    join(repoRoot, 'src', 'server', 'worktreeRoutes.ts'),
