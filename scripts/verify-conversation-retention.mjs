...
const outputRoot = new URL('../output/conversation-retention-smoke/', import.meta.url)
mkdirSync(outputRoot, { recursive: true })
const outfile = fileURLToPath(new URL('entry.mjs', outputRoot))
await build({
  entryPoints: [fileURLToPath(new URL('./conversation-retention-smoke.ts', import.meta.url))],
