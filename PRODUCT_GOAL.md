...
维护者对既往发布的风险豁免不改变目标状态：在以上门槛全部有权威证据前，M1、M2、M4、M5 与总目标保持未完成；外部项不因本地绕过、文档说明或测试替身而自动关闭。
