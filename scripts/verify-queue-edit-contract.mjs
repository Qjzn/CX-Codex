...
const outputRoot = new URL('../output/queue-edit-contract-smoke/', import.meta.url)
mkdirSync(outputRoot, { recursive: true })
const outfile = fileURLToPath(new URL('entry.mjs', outputRoot))
await build({
  entryPoints: [fileURLToPath(new URL('./queue-edit-contract-smoke.ts', import.meta.url))],
